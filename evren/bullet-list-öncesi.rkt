...
(define (evren-güncelle e)
  ...
  (map nesne-fizik-güncelle bullet-list))) 



(define (evren-çiz e)
  (cond [(> (length bullet-list) 0) (foldr nesne-çiz () (list (evren-nesne-e e) (evren-nesne-d e)
                                         (evren-nesne-a e) (evren-nesne-b e) (evren-nesne-c e) (evren-arkaplan e) ))  ]
        [else (nesne-çiz (evren-nesne-e e)(nesne-çiz (evren-nesne-d e)
                                         (nesne-çiz  (evren-nesne-a e) (nesne-çiz (evren-nesne-b e)
                                                                                  (nesne-çiz (evren-nesne-c e) (evren-arkaplan e) )) )))] ))
