...
(define nesne2 (nesne (set-resolution 78 78 (bitmap "imaj/trash1.png")) (v 200 78) (v 0 (random 1 10)) (v 0 0) 1 0))
...
(define nesne5 (nesne (set-resolution 78 78 (bitmap "imaj/trash1.png")) (v 400 78) (v 0 (random 1 10)) (v 0 0) 1 0))

(define bullet-list (list))
...
;;
(STRUCT evren (arkaplan nesne-a nesne-b nesne-c nesne-d nesne-e b-liste))

(define (evren-güncelle e)
  (evren (evren-arkaplan e) (nesne-fizik-güncelle (evren-nesne-a e))
  (alttan-sek (nesne-fizik-güncelle (evren-nesne-b e)) BACKGROUND) (alttan-sek (nesne-fizik-güncelle (evren-nesne-c e)) BACKGROUND) (alttan-sek (nesne-fizik-güncelle (evren-nesne-d e)) BACKGROUND) (alttan-sek (nesne-fizik-güncelle (evren-nesne-e e)) BACKGROUND)
  ())) 



(define (evren-çiz e)
  (cond [(> (length bullet-list) 0) (map nesne-çiz bullet-list (nesne-çiz (evren-nesne-e e)(nesne-çiz (evren-nesne-d e)
                                         (nesne-çiz  (evren-nesne-a e) (nesne-çiz (evren-nesne-b e) (nesne-çiz (evren-nesne-c e) (evren-arkaplan e) )) ))))] [else (nesne-çiz (evren-nesne-e e)(nesne-çiz (evren-nesne-d e)
                                         (nesne-çiz  (evren-nesne-a e) (nesne-çiz (evren-nesne-b e) (nesne-çiz (evren-nesne-c e) (evren-arkaplan e) )) )))] ))
...
(define (tuş-ateş t) (
                     cond [(string=? t "space") (cons (nesne (rectangle 20 30 "solid" "red")
                                                             (v (v-x (nesne-yer oyuncu)) (- (v-y (nesne-yer oyuncu))
                                                                                            (/ (image-height (nesne-imaj oyuncu)) 2))) 30 0 0 0) bullet-list)] [else false]))
...
(define yaradılış (evren BACKGROUND oyuncu nesne2 nesne3 nesne4 nesne5 bullet-list))
