...
(define (evren-güncelle e)
  (evren (evren-arkaplan e) (ekrandan-cik (nesne-fizik-güncelle (evren-nesne-a e)) BACKGROUND)
...
(define (evren-çiz e)
  (nesne-çiz (evren-nesne-e e)(nesne-çiz (evren-nesne-d e)(nesne-çiz (evren-nesne-c e)(nesne-çiz (evren-nesne-b e)(nesne-çiz (evren-nesne-a e)
...
(define (tuş-ateş e t) (cond [(< (length (evren-b-liste e)) 5)(
                     cond [(string=? t "k") (cons (nesne (rectangle 20 30 "solid" "red")
                                                             (v (v-x (nesne-yer (evren-nesne-a e))) (- (v-y (nesne-yer (evren-nesne-a e)))
                                                                                            (/ (image-height (nesne-imaj (evren-nesne-a e))) 2))) (v 0 -30) (v 0 0) 0 0) (evren-b-liste e))] [else (evren-b-liste e)])] [else (evren-b-liste e)]))
