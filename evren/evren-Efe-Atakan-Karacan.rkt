...
(define nesne1 (nesne (set-resolution 100 100 (bitmap "imaj/rocket.png")) (v 350 400) (v 0 1) (v 0 1)))
(define nesne2 (nesne (set-resolution 78 78 (bitmap "imaj/trash1.png")) (v 200 500) (v 0 2) (v 0 2)))
(define nesne3 (nesne (set-resolution 100 100 (bitmap "imaj/trash2.png")) (v 100 50) (v 0 2) (v 0 2)))
...
(define (alttan-sek n imaj)
  (cond [
         ...
         (v (random (+ 0 (/ (image-width (nesne-imaj n)) 2)) (- (image-width BACKGROUND) (/ (image-width (nesne-imaj n)) 2))) (+ 0 (/ (image-height (nesne-imaj n)) 2))) (nesne-hız n)(nesne-ivme n))] [else n]))
